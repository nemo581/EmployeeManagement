...
<head>
    ...
    <style>
        ...
        .content-block {
            padding: 0 20px; /* Точно те же отступы слева/справа, что и у .status */
        }
        .status {
            padding: 15px 0; /* Только вертикальный padding, горизонтальный — от обёртки */
            background: #ecf0f1;
        ...
        .btn {
            display: block;
            width: 100%;
            padding: 16px 0; /* Только вертикальный padding, горизонтальный — от обёртки */
            margin-bottom: 15px;
            background: #3498db;
            color: white;
            font-size: 1.2rem;
