...
<html lang="ru">
    <head>
        ...
        <style>
            .employee-card { max-width: 1100px; margin: 0 auto 30px; background: #fff; border-radius: 8px;
            ...
            .employee-photo { width: 160px; height: 160px; border-radius: 10px; object-fit: cover;
                border: 3px solid #fff; box-shadow: 0 3px 10px rgba(0,0,0,0.08); }

            .employee-photo-placeholder { width: 160px; height: 160px; border-radius: 10px; background: #e9ecef;
                display: flex; align-items: center; justify-content: center; font-size: 64px; color: #adb5bd; }

            .employee-main-info { flex: 1; padding-top: 8px; }

            .employee-name { margin: 0 0 6px 0; font-size: 26px; line-height: 1.2; }

            .employee-position { margin: 0 0 4px 0; font-size: 17px; color: #495057; }

            .employee-department-shift { color: #6c757d; font-size: 14px; }

            .employee-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr));
                gap: 0; padding: 0 32px 24px 32px; }

            .detail-row { display: flex; padding: 10px 0; border-bottom: 1px solid #f0f0f0; gap: 16px; }
            ...
            .back-link { display: inline-block; margin: 20px 0 24px; color: #0d6efd;
